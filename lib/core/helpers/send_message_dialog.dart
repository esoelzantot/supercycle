        ...
        child: Column(
          ...
          children: [
            ...
            _buildOption(
              ...
              title: 'WhatsApp',
              subtitle: S.of(context).send_message_dialog_whatsapp_option,
            ...
            _buildOption(
              ...
              title: 'Email',
              subtitle: S.of(context).send_message_dialog_email_option,
  ...
  Widget _buildHeader() {
    return Column(
      children: [
        ...
        Text(
          S.of(context).send_message_dialog_title,
          style: AppStyles.styleBold22(context),
        ),
        const SizedBox(height: 4),
        Text(
          S.of(context).send_message_dialog_subtitle,
      ...
      children: [
        Expanded(
          ...
          child: TextButton(
            ...
            child: Text(
              S.of(context).send_message_dialog_cancel_button,
        ...
        Expanded(
          ...
          child: ElevatedButton(
            ...
            child: Text(
              S.of(context).send_message_dialog_send_button,
              style: AppStyles.styleSemiBold20(
                context,
